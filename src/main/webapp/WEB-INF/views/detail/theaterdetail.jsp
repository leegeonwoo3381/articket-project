...
<!--     <meta content="" name="description">
    ...
    <!-- Favicons -->
    <link href="${path}resources/favicon.png" rel="icon">
    <link href="${path}resources/img/detail/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="detail.html" class="logo d-flex align-items-center  me-auto me-lg-0">
        <!-- Uncomment the line below if you also wish to use an image logo -->
        <!-- <img src="resources/img/detail/logo.png" alt=""> -->
        <i class="bi bi-camera"></i>
        <h1><a class="navbar-brand" href="index" style="color: rgb(255, 005, 088);">Articket <span style="color: white;;">Articket</span></a></h1>
      </a>
<div class="nav-left">
      <nav id="navbar" class="navbar">
      <ul>
         <li><a href="#!" class="active">연극</a></li>
         <li ><a href="#!" class="active">뮤지컬</a></li>
         <li ><a href="#!" class="active">콘서트</a></li>
         <li ><a href="/board" class="active">게시판</a></li>
     </ul>
      </nav><!-- .navbar -->
      </div>
  ...
  <!-- <main id="main" data-aos="fade" data-aos-delay="1500"> -->
    <main id="main">
      <form action="../tiketting/calendar-17/tiketting.html">
    <!-- ======= End Page Header ======= -->
    <div class="page-header d-flex align-items-center">
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-xs-6 text-center">
            <h2 name="title">연극 〈극적인 하룻밤〉</h2>
          </div>
        </div>
      </div>
    </div><!-- End Page Header -->
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-3">
            <img src="resources/img/detail/top-img.gif" class="img-fluid" alt="">
          </div>
          <div class="col-lg-5 content">
            <h2 name="address">장소 : 바탕골소극장 서울</h2>
            ...
            <div class="row">
              <div class="col-lg-12">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>공연기간:</strong> <span>2014.09.26~2019.02.24</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>공연시간:</strong> <span>90분</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>관람연령:</strong> <span>만 13세이상</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>가격:</strong> 
                                ...
                                <ul class="sm-6">
                                    <li class="dropdown" ><span>전체가격보기</span> <i class="bi bi-chevron-down dropdown-indicator"></i>
                                        <ul style="width:300px;">
                                          <li class="mouse-pointer"> <a href="#"></a> S석 : 69,000원</li>
                                          <li class="mouse-pointer"> <a href="#"></a> R석 : 59,000원</li>
                                          <li class="mouse-pointer"> <a href="#"></a> A석 : 49,000원</li>
                                          <li class="mouse-pointer"> <a href="#"></a> B석 : 39,000원</li>
                                          <li class="mouse-pointer"> <a href="#"></a> C석 : 29,000원</li>
                                          <li class="mouse-pointer"> <a href="#"></a> standing : 19,000원</li>
              ...
              <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="scroll-container">
                        ...
                        <!--     <a class="cta-btn" id="ticketing" >예 매 하 기</a> -->
                            <a href="<c:url value='/ticketing'/>" class="cta-btn">예 매 하 기</a>
                            <br>
                            <br>
        ...
        <div class="row">
          <div class="col">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#zxc">Q&A</a>
                </li>
              </ul>
...
<div class="row gy-12 justify-content-center">
    <div class="col-lg-6">
      <img src="resources/img/detail/main-poster.jpg" class="img-main-poster img-fluid" alt="" style="clear:both">
    </div>
...
<!--  	<form action="#" class="mb-3" name="myform" id="myform" method="post"> -->
    ...
    <div id="aaaa"  class="swiper-wrapper">
...
<!--   </form> -->
  ...
  <script src="resources/js/detail/main.js"></script>
